...
class Runner(object):
  ...
  def _build_train_spec(self, checkpoint_path):
    ...
    if checkpoint_path is not None and "load_weights" in self._config:
      ...
      if loadw is not None:
        ...
        if not loadw.get("optim"): 	# if true, also avoids global_step and word_per_sec
      ...
      train_hooks.append(hooks.LoadWeightsFromCheckpointHook(checkpoint_path, not_restore))
  ...
  def update_vocab(self,
    ...
    Args:
     ...
    """ 
    checkpoint.update_vocab(checkpoint_path,
                          output_dir,
                          src_vocab,
                          tgt_vocab,
                          shared_vocab,
