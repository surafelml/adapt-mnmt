...
def main():
  ...
  parser.add_argument("run",
                      choices=["train_and_eval", "train", "eval", "infer", "export", "score", "update_vocab"],
                      help="Run type.")
  ...
  parser.add_argument("--init", default="zeros", choices=["zeros", "random"],
                      help="Initialization term for newly updated vocab/embs.")
  #parser.add_argument("--pretrained_embs", default=False, action="store_true",
